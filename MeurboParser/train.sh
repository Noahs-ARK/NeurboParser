...
for output_term in $output_terms; do
	...
	log_file=${curr_dir}/log/${trainer}.${output_term}.lstm${lstm_dim}.layer${num_lstm_layers}.h${mlp_dim}.r${rank}.drop${word_dropout_rate}.log
