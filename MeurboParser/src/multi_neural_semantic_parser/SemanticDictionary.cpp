...
DEFINE_int32(role_cutoff, 30,
             "Ignore role labels whose frequency is less than this.");
...
void SemanticDictionary::CreatePredicateRoleDictionaries(const string &formalism, SemanticReader *reader) {
    ...
    bool allow_unseen_predicates =
            static_cast<NeuralSemanticPipe *>(pipe_)->GetSemanticOptions()->
