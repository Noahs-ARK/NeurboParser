...
#include "../multi_neural_semantic_parser/SemanticOptions.h"
#include <algorithm>

void DependencyDictionary::CreateLabelDictionary(const string &formalism, DependencyReader *reader) {
    ...
    SemanticOptions *semantic_options = static_cast<SemanticOptions *>(pipe_->GetOptions());
    reader->Open(semantic_options->GetTrainingFilePath(formalism));
...
void DependencyTokenDictionary::Initialize(const string & formalism, DependencyReader *reader) {
