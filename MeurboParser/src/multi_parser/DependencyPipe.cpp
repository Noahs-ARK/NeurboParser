...
void DependencyPipe::LoadPrunerModel(FILE *fs) {
    ...
    // This will be ignored but must be task2sed to the pruner pipe constructor,
...
// If necessary, root nodes are added and task2sed back through the last
// argument.
...
// Make sure the graph formed by the unlabeled arc parts atask1its a projective
